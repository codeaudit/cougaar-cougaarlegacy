/*
 * TODO: change this for javadoc compatability
 *  Title:        DebugFrame.java
 *  Version:      v 3.0
...
public class DebugFrame extends Frame
{
  ...
  private boolean inDebugMode = true;       // globally controlls all debugging output
  ...
  {
    if (inDebugMode && outputToFrame)
      textArea.append (text + "\n");

    if (inDebugMode && outputToFile)
    {
