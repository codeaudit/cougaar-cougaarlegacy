...
java %POLICY% EDU.cmu.CoABS.Grid.Proxy.InterOp -h %RETSINA_ANS_HOST% -p %RETSINA_ANS_PORT% -a CNNCurrentWeatherAgent -d "The CNN Weather Agent providing current information (canned data)" -o "weather" 
