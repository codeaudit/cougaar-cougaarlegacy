...
set AEF_CONFIG_PATH=-Dorg.cougaar.config.path=%LIAISON_CONFIG%\tasc\RuntimeData;%LIAISON_CONFIG%\tasc\RuntimeData\DBSetup;
...
pushd %LIAISON_HOME%\configs\tasc

java.exe %VMPARAMETERS% %MYPROPERTIES% %AEF_CONFIG_PATH% %LPROPERTIES% -classpath %LIBPATHS% %MYCLASSES% %MYARGUMENTS%
