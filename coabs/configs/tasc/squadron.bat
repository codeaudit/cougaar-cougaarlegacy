...
java -Dorg.cougaar.install.path=%ALP_INSTALL_PATH% %MYPROPERTIES% -classpath %LIBPATHS% org.cougaar.domain.Airforce.UI.AircraftSchedule.AircraftScheduleApplication
