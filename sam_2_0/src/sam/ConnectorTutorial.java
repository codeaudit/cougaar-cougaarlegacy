 ...
 * @author John Reekie
 *
 * $Id: ConnectorTutorial.java,v 1.1 2003-05-20 15:23:52 tom Exp $
 *
...
public class ConnectorTutorial {
    ...
    private StraightConnector connectorB;
    ...
    public ConnectorTutorial () {
        ...
        TutorialWindow window = new TutorialWindow("Connector tutorial");
    ...
    public void createConnectors () {
        ...
        Site c = figureA.getS();
        Site d = figureB.getW();
        connectorB = new StraightConnector(c,d);
     ...
     */
    public class SRTarget implements ConnectorTarget {
